const translations = {
  en: {
    ...
    contactDesc: "Tell us about your store and we will prepare a tailored walkthrough.",
    contactQuickNote: "Start an instant WhatsApp chat with our team.",
    contactChatBtn: "Chat on WhatsApp",
    formName: "Your Name",
    ...
    posCtaDesc: "Open a demo store, add products, and run transactions in minutes.",
    posCtaBtn: "Launch Demo",
    galleryTag: "Project Gallery",
    galleryTitle: "POS interfaces and implementation snapshots",
    galleryDesc: "Explore dashboards, checkout flows, inventory pages, and analytics screens.",
    g1: "Main Dashboard",
    g2: "Checkout Screen",
    g3: "Inventory Module",
    g4: "Stock Alerts",
  ...
  ar: {
    ...
    contactDesc: "شاركنا تفاصيل متجرك وسنجهز لك عرضًا مناسبًا.",
    contactQuickNote: "ابدأ محادثة واتساب مباشرة مع فريقنا.",
    contactChatBtn: "الدردشة عبر واتساب",
    formName: "الاسم",
    formEmail: "بريد العمل",
    formMessage: "اكتب احتياجك",
    ...
    posCtaDesc: "افتح متجرًا تجريبيًا وأضف المنتجات ونفذ عمليات البيع خلال دقائق.",
    posCtaBtn: "ابدأ التجربة",
    galleryTag: "معرض المشاريع",
    galleryTitle: "واجهات ولقطات تنفيذ نظام نقاط البيع",
    galleryDesc: "استكشف لوحات التحكم وشاشات الدفع والمخزون والتحليلات.",
    g1: "لوحة التحكم الرئيسية",
    g2: "شاشة الدفع",
    g3: "وحدة المخزون",
    g4: "تنبيهات المخزون",
    g5: "لوحة التحليلات",
